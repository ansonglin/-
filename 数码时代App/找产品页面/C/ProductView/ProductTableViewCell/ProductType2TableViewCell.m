...
@implementation ProductType2TableViewCell
...
- (void)layoutSubviews
{
    ...
    self.logo1.frame = CGRectMake(0, 0, self.frame.size.width / 2, self.frame.size.height);
    [_logo1 setImage:[UIImage imageNamed:@"apple.png"]];
//    self.logo2.frame = CGRectMake(0, self.frame.size.height / 2, self.frame.size.width / 4, self.frame.size.height / 2);
//    [_logo2 setImage:[UIImage imageNamed:@"microsoft.png"]];
//    self.logo3.frame = CGRectMake(self.frame.size.width / 4, self.frame.size.height / 2, self.frame.size.width / 4, self.frame.size.height / 2);
//    [_logo3 setImage:[UIImage imageNamed:@"samsungLogo.png"]];
    self.bigPic.frame = CGRectMake(self.frame.size.width / 2, 0, self.frame.size.width / 2, self.frame.size.height);
    [_bigPic setImage:[UIImage imageNamed:@"ipad.png"]];
}
